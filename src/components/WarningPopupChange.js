...
function WarningPopupChange({ closePopup, parentSubmit, msg, imgPath, screen }) {
                ...
                <div className="point-error-card" style={{paddingTop: '29px'}}>
                    ...
                    <div className="content" style={{marginTop: '0px', marginLeft: '5px', marginRight: '5px'}}>
                        ...
                        <div className="btn-wrapper center-all">
                            <button className="btn btn-primary center-all"  style={{justifyContent: 'center'}} onClick={() => parentSubmit()}>Tiếp tục</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default WarningPopupChange;