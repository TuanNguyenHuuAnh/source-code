...
function AlertPopupInvalidUser({ closePopup, msg, imgPath, screen }) {
        ...
        <div className="alert popup special point-error-popup show">
            <div className="popup__card">
                <div className="point-error-card">
                    <div className="close-btn" style={{ marginTop: '-17px', marginRight: '0'}}>
                      {screen && (screen === SCREENS.UPDATE_POLICY_INFO)?(
                        ...
                        screen && (screen === SCREENS.UPDATE_CONTACT_INFO)?(
                            ...
                            (screen === SCREENS.HOME)?(
                                <Link to="/" onClick={() => close()}><img src="../../img/icon/close.svg" alt=""/></Link>
                            ):(
                    ...
                    <div className="content" style={{marginLeft: '5px', marginRight: '5px'}}>
                        <p style={{ fontWeight: 700, fontSize: 16 }}>Rất tiếc!</p>
                        <p>{msg?msg: ''}</p>
                    </div>
                </div>
            </div>
...
export default AlertPopupInvalidUser;