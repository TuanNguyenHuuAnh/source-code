...
export const PUBLIC_KEY_DLVN = "-----BEGIN PUBLIC KEY----------END PUBLIC KEY-----";
export const OMIDOCS_TYPE_MAPPING = {"ApplicationForm":"Yêu cầu bảo hiểm nhân thọ", "HealthDeclarationForm":"Tờ khai sức khỏe", "Insight":"Tài liệu minh họa quyền lợi sản phẩm bảo hiểm", "FCReport":"Báo cáo Tư vấn khách hàng","CustomerReport":"Bảng đánh giá khả năng tài chính", "ShareLifeInsuredForm":"Phiếu chỉ định, thay đổi Người được SHBV", "AdditionalInformation":"Phiếu yêu cầu bổ sung thông tin chi tiết Hợp đồng bảo hiểm", "RecordingFile":"File ghi âm/ghi hình"}
export const RECORDING_BASE_URL = 'https://dlvnvideouat.dai-ichi-life.com.vn/api/v1/stream/';
export const NUM_OF_RETRY_OMI_DOCS = 0;
export const PERSONAL_INFO_STATE = Object.freeze({
    INIT: 0,
    CHOOSE_LI: 1,
    UPDATE_INFO: 2,
    ATTACHMENT: 3,
...
export const SDK_MODE_SINGLE = 1;
export const CCCD_QR_CODE = 'CCCDCF';
export const OCR_UNIDENTIFIED = 'Unidentified';
export const PURPOSE_OF_RESIDENCE = ['Du học', 'Công tác', 'Định cư', 'Xuất khẩu lao động', 'Du lịch', 'Thăm người thân', 'Khác'];
export const TIME_OF_RESIDENCE =[{code:'≤ 6 tháng', name:'Không quá 6 tháng'}, {code: '> 6 tháng', name: 'Trên 6 tháng'}];
export const IDDOCUMENTS_FRONT = 'IDDocuments_Front';//CCCD mặt trước
export const IDDOCUMENTS_BACK = 'IDDocuments_Back';//CCCD mặt sau
export const CCCD_NAME = 'Căn cước công dân/Thẻ căn cước';
export const BIRTH_CERT = 'Giấy khai sinh';
export const IDDOCUMENTS_BC = 'IDDocuments_BC';//SubdocID giấy khai sinh
export const IDDOCUMENTS_PP = 'IDDocuments_PP';//SubdocID Passport
export const OTHERS = 'Others';//SubdocID Others
export const OTHERS_NC = 'Others_NC';//SubdocID Others_NC
export const OTHERS_CV = 'Others_CV';//SubdocID Others_CV

export const GENDER_MAP={'M': 'Nam', 'F': 'Nữ'};
export const CCCD_FRONTS=['CCCDF', 'CCCDCF', 'CC2024F'];
export const CCCD_BACKS=['CCCDB', 'CCCDCB', 'CC2024B'];
export const PASSPORT='PP';
export const GKS = 'GKS';
export const PERSONAL_INFO_SAVE_LOCAL = "personalInfoSaveLocal";
export const TEMP_OF_USE = '/terms-of-use';
export const PRIVACY_POLICY = '/privacy-policy';
export const DOCUMENTS_ORDER = ['IDDocuments_Front', 'IDDocuments_Back', 'IDDocuments_PP', 'IDDocuments_BC', 'Others_NC', 'Others_CV', 'Others'];
export const DOCUMENTS_HINT_MAP = {'IDDocuments_Front': 'Chụp hình mặt trước', 'IDDocuments_Back': 'Chụp hình mặt sau', 'IDDocuments_PP': 'Chụp hình Hộ chiếu', 'IDDocuments_BC': 'Chụp hình Giấy khai sinh'};
export const CACHE_TRACKING_ID = "cacheTrackingId";
export const CACHE_PERSONALINFO_KEY = "cachePersonalInfoKey";
//SDK Claim
export const CODE_SUCCESS = "0000";
export const CODE_ERROR_AUTHEN = "4001";

export const CLAIM_STEPCODE = {
    CREATE_REQUEST: 'CREATE_REQUEST',
    CREATE_AUTHORIZION: 'CREATE_AUTHORIZION',
    CONFIRM_AUTHORIZION: 'CONFIRM_AUTHORIZION',
    INIT: 'INIT',
    ...
    DONE: 'DONE',
    SDK_DLCN: 'SDK_DLCN',
    // ND13_INFO_CONFIRMATION: 'ND13_INFO_CONFIRMATION',
    // ND13_INFO_PO_CONTACT_INFO_OVER_18: 'ND13_INFO_PO_CONTACT_INFO_OVER_18',
    // ND13_INFO_PO_CONTACT_INFO_UNDER_18: 'ND13_INFO_PO_CONTACT_INFO_UNDER_18',
    // ND13_INFO_FOLLOW_CONFIRMATION: 'ND13_INFO_FOLLOW_CONFIRMATION',
    TRACKING_CLAIM: 'TRACKING_CLAIM'
};

export const SDK_REQUEST_STATUS = {
    CREATE_REQUEST: 'REQUEST',
    WAITING_AGENT_CONFIRM: 'WAITINGAGENTCONFIRM',
    INITIAL: 'INITIAL',
    EDIT: 'EDIT',
    POREVIEW: 'POREVIEW',
    REEDIT: 'REEDIT',
    WAIT_CONFIRM_DATAPERSONAL: 'WAIT_CONFIRM_DATAPERSONAL',
    REJECT_AUTHORIZED: 'REJECT_AUTHORIZED',
    REJECT_CLAIM: 'REJECT_CLAIM',
    REJECT_DLCN: 'REJECT_DLCN',
    CONFIRM: 'CONFIRM',
    DELETE: 'DELETE',
    WAITINGCONFIRMDLCN: 'WAITINGCONFIRMDLCN'
};
export const SDK_ROLE_PO = 'PO';
export const SDK_ROLE_AGENT = 'AGENT';
export const FROM_SDK = 'fromSDK';
export const REVIEW_LINK = 'reviewLink';
export const SDK_REVIEW_PROCCESS = 'REVIEW_PROCCESS';
export const REVIEW_LINK_LOGINED = 'reviewLinkLogined';
export const CONSENT_RULE_ID_ND13 = 'ND13';
export const CONSENT_RULE_ID_CLAIM_PAYMENT = 'CLAIM_PAYMENT';
export const AUTHORZIE_STATUS_CODE_APPROVE = 'Approval';
export const AUTHORZIE_STATUS_CODE_NOT_APPROVE = 'NotApproval';
export const AUTHORZIE_STATUS_CODE_NOT_CREATE = 'NotCreate';
export const CLAIM_EXPIRE_STATUS_MASTER_LIST = ['REJECT_CLAIM', 'CONFIRM', 'DELETE', 'CANCEL', 'REJECT_AUTHORIZED'];
export const AGENT_CLAIM_EXPIRE_STATUS_MASTER_LIST = ['REJECT_CLAIM', 'REJECT_DLCN', 'CONFIRM', 'DELETE', 'CANCEL', 'REJECT_AUTHORIZED'];
export const CLAIM_STATUS_TITLE_MAPPING={'ALL':'tất cả', 'EDIT': 'đang khởi tạo', 'POREVIEW': 'chờ BMBH xác nhận', 'REEDIT': 'chờ điều chỉnh', 'REJECT_CLAIM': 'yêu cầu bị hủy', 'REJECT_DLCN': 'yêu cầu bị hủy', 'CANCEL': 'yêu cầu bị hủy', 'CONFIRM': 'Đã nộp'};
