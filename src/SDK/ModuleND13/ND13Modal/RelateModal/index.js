...
import {iibGetMasterDataByType} from "../../../sdkAPI";
                    ...
                    <div className="popup__card">
                        <div className="relate-modal-card">
                            <div className="modal-header">
                                <p className="modal-header-title">Đồng ý xử lý Dữ liệu cá nhân</p>
                            ...
                            <div className="relate-modal-content">
                                <p className="modal-body-content">Nhằm tuân thủ Nghị định 13/2023/NĐ-CP ngày 17/04/2023 về
                                    bảo vệ DLCN, Chủ thể dữ liệu cần xác nhận đồng ý cho phép DLVN xử lý DLCN.</p>
                                <div className="card-border"></div>
                                {/*----------------------------------------LI > 18T: PO khai báo thông tin liên hệ của LI------------------------------------------------------*/}
                                <p className="modal-body-sub-content">Quý khách vui lòng cung cấp thông tin liên hệ của
                                    (những)
                                ...
                                <div className={`collapsible ${isActive ? 'active' : ''}`}>
                                    <div className="collapsible-header" onClick={toggleCollapsible}>
                                        <p className={`modal-body-sub-content ${isActive ? 'bold-text' : ''}`}>Đặng Trần
                                            Nguyễn Quốc Nam</p>
                                    ...
                                    <div className="collapsible-content">
                                        ...
                                        <div
                                            ...
                                            <div className="input__content">
                                                ...
                                                <input value={relateModalData.email.value?relateModalData.email.value.trim():''} name="email" id="relateEmail"
                                                       onChange={(e) => setRelateModalData({
                                                           ...relateModalData,
                                                           email: {
                                                               ...relateModalData.email,
                                ...
                                <p className="modal-body-sub-content">Nếu trẻ dưới 18 tuổi, việc xử lý DLCN cần sự
                                    đồng ý của trẻ (từ 7 tuổi) và Cha/Mẹ/Người giám hộ của trẻ.</p>
                                ...
                                <div className={`collapsible ${isActiveRelate ? 'active' : ''}`}>
                                    <div className="collapsible-header" onClick={toggleCollapsibleRelate}>
                                        <p className={`modal-body-sub-content ${isActiveRelate ? 'bold-text' : ''}`}>Tên
                                            NĐBH 1</p>
                                    ...
                                    <div className="collapsible-content">
                                        ...
                                        <div className="body-func">
                                            <h5 className="basic-semibold" style={{fontSize: 16}}>Mục đích 1,2,3</h5>
                                            <div className="checkbox-warpper">
                                                <div className="checkbox-item">
                                                    <div className="round-checkbox">
                                                        <label className="customradio">
                                ...
                                <div className="relate-po-wrapper">
                                    <p className="relate-po-policy-content">
                                        Số tiền yêu cầu &lt; [X], nếu được DLVN chấp thuận chi trả và Quý khách
                                        chọn Người nhận tiền là Bên mua bảo hiểm, vui lòng xác nhận và điền
                                        thông tin dưới đây:
                                    </p>
                                    <div
                                        ...
                                        <div className={acceptPolicy ? "square-choose fill-red" : "square-choose"}
                                             style={{flex: '0 0 auto', height: '20px', cursor: 'pointer', margin: 0}}
                                        ...
                                        <div className="accept-policy-wrapper" style={{
                                            ...
                                            <p>Tôi, Bên mua bảo hiểm, đồng ý và cam kết: Nếu được DLVN chấp thuận chi
                                                trả
                                                quyền lợi bảo hiểm cho yêu cầu này, Tôi là Bên mua bảo hiểm, sẽ nhận
                                                số
                                                tiền do DLVN thanh toán theo phương thức thanh toán mà Tôi đã cung cấp.
                                                Tôi
                                                cam kết chịu trách nhiệm trước pháp luật về việc nhận tiền này và
                                                miễn
                                                trừ DLVN khỏi các khiếu nại, tranh chấp về việc thanh toán, nếu
                                                có. </p>
                                        </div>
                                    </div>
                                </div>
