                    ...
                    <div className="modal-common-card">
                        ...
                        <div className="picture-wrapper">
                            <div className="picture">
                                <img src={DATA_DECREE.PROFILE_DC_WARNING.image} alt="popup-hosobg" />
                            </div>
                        </div>
                        <div className="content">
                            ...
                            }}>{DATA_DECREE.PROFILE_DC_WARNING.title}</p>
                            <p className="modal-body-content" style={{
                                ...
                                {DATA_DECREE.PROFILE_DC_WARNING.msg}
                                <span className="modal-body-link"> customer.services@dai-ichi-life.com.vn</span>.
                            </p>
