...
import './styles.css';
import {removeAccents, VALID_EMAIL_REGEX} from "../../../sdkCommon";
import {iibGetMasterDataByType} from "../../../sdkAPI";
import {SearchOutlined} from "@ant-design/icons";

const ND13POPersonalInfo = (props) => {
        const {Option} = Select;
                ...
                case "identityCard":
                    setRelateModalData({
                        ...
                        identityCard: {
                            ...
                            value: value,
                            error: value.length > 14 ? "Căn cước công dân/Thẻ căn cước không được quá 14 chữ số" : "",
                        },
                    });
                    if (value.length > 14) {
...
export default ND13POPersonalInfo;
