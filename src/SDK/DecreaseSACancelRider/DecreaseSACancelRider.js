...
import DecreaseSACancelRiderWrapper from './DecreaseSACancelRiderWrapper';
...
let fromNative = '';
class DecreaseSACancelRider extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        cpSaveLogSDK(`Web_Open_${PageScreen.POL_TRANS_CHANGE_DECREASE_SA}`, this.state.apiToken, this.state.deviceId, this.state.clientId);
        trackingEvent(
            "Giao dịch hợp đồng",
    ...
    componentWillUnmount() {
        ...
        cpSaveLogSDK(`Web_Close_${PageScreen.POL_TRANS_CHANGE_DECREASE_SA}`, this.state.apiToken, this.state.deviceId, this.state.clientId);
        trackingEvent(
            "Giao dịch hợp đồng",
            `Web_Close_${PageScreen.POL_TRANS_CHANGE_DECREASE_SA}`,
            `Web_Close_${PageScreen.POL_TRANS_CHANGE_DECREASE_SA}`,
        );
    }
...
export default DecreaseSACancelRider;