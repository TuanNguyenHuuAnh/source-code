...
import {SCREENS, PREVIOUS_SCREENS} from '../sdkConstant';
import { setSession } from '../sdkCommon';

function AuthenticationPopupClaim({ closePopup, msg, screen, agree }) {
                ...
                <div className="phone-confirm-card">
                    ...
                    <div className="content">
                        ...
                        <div className="btn-wrapper">
                            <Link className="btn btn-primary" to={"/account"} onClick={() => agreeClose()}>Xác thực ngay</Link>
                        </div>
                    </div>
                </div>
            </div>
