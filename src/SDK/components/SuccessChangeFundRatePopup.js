...
function SuccessChangeFundRatePopup({ closePopup, policyNo, screen }) {
            ...
            <div className="popup__card">
                <div className="point-error-card">
                    ...
                    <div className="content">
                        ...
                        <p style={{padding: '12px'}}>Yêu cầu chỉ được xử lý khi Phí bảo hiểm được nộp đầy đủ vào cùng ngày. Quý khách vui lòng nộp Phí bảo hiểm bằng các hình thức khác hoặc đóng phí trực tuyến ngay trên ứng dụng để hoàn tất yêu cầu.</p>
...
export default SuccessChangeFundRatePopup;