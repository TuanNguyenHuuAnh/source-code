...
import {maskPhone, deleteND13DataTemp, getUrlParameter, getSession, formatFullName, trackingEvent, cpSaveLogSDK } from '../../util/common';
import {callbackAppOpenLink} from '../sdkCommon';
import {onlineRequestSubmitESubmission, genOTP, CPConsentConfirmation, onlineRequestSubmitConfirm} from '../../util/APIUtils';
...
let from = '';
class PaymodeDetail extends Component {
    constructor(props) {
        super(props);
    ...
    submitProccessConfirm = (OTP) => {
        let submitRequest = {
            jsonDataInput: {
              ...
              Action: CONFIRM_ACTION_MAPPING[this.props.proccessType],
        ...
        const changePayModeSubmit = () => {
            ...
            let submitRequest = {
                jsonDataInput:{
                   ...
                   NewValue:{
                      FrequencyName: this.state.newFrequency,
                      NewPremiumMode: this.state.newFrequencyCode,
                      NewSundryAmount: this.state.newPolMPremAmt,
                      MPremiumAmount: this.state.polMPremAmt.replaceAll('.', ''),
                      ExcessPremiumAmount: this.state.polMPremAmtAddtional?this.state.polMPremAmtAddtional: 0
                   },
                   OldValue:{
                      FrequencyName: this.props.Frequency,
                      NewPremiumMode: this.props.FrequencyCode,
                      NewSundryAmount: this.props.PolMPremAmt
                   },
                   OS: WEB_BROWSER_VERSION,
                   PolicyNo: this.props.polID,
                   Project: "mcp",
                ...
                <section style={{
                    ...
                    <div className="stepform">
                        ...
                        <div className="contractform__body">
                            {this.props.stepName === FUND_STATE.UPDATE_INFO? (
                            <div className="info">
                                <div className="info__title nd13-padding-bottom16">CHỌN ĐỊNH KỲ ĐÓNG PHÍ CẦN ĐIỀU CHỈNH</div>
                                <div className="checkbox-wrap basic-column">
                                        <div className="tab-wrapper">
                                        {this.props.ClientProfile !== null && this.props.ClientProfile.map((item, index) => (
                                            <div className="tab">
                                                    ...
                                                    <div className="checkbox-item">
                                                        <div className="round-checkbox">
                                                            <label className="customradio">
                                                                <input type="checkbox"
                                                                        checked={this.state.newFrequency === item.Frequency}
                                                                        onClick={() => radioFrequency(item.Frequency, item.PolMPremAmtMax, item.PolMPremAmt, item.FrequencyCode)}
                                                                        id='payModeYear'/>
                                                ...
                                                <div className="info__content">
                                                    <div className="contractform__head-content">
                                                        <div className="item">
                                                            <p className="item-label">Phí định kỳ/cơ bản định kỳ (tạm tính)</p>
                                                            <p className="claim-submission-text">{item.PolMPremAmt} VNĐ</p>
                                                        </div>
                                                    </div>
                                                    {(this.state.newFrequency === item.Frequency) && (this.props.PolicyClassCD !== 'TL') && (this.props.PolicyClassCD !== 'VE') && (this.props.PolicyClassCD !== 'MTL') &&
                                                        <>
                                                        <div className="info__content-item">
                                                            <div className="input money">
                                                                <div className="input__content">
                                                                    <label>Phí đóng thêm định kỳ</label>
                                                                    <NumberFormat className="basic-uppercase"
                                                                            id='txtInputAmount'
                                                                            // inputmode="numeric"
                                                                            type='seach'
                                                                            value={this.state.polMPremAmtAddtional?this.state.polMPremAmtAddtional: 0}
                                                        ...
                                                        <div className="optionalform__title">
                                                            <p style={{ display: 'flex', marginTop: '12px', marginBottom: '8px' }}>Phí dự tính định kỳ
                                                                <span style={{marginTop: '-8px', width: '16px', height: 'auto'}}>
                                                            ...
                                                            <div className="info__content-item" style={{ marginTop: '12px', marginBottom: '8px' }}>
                                                                <p className='basic-red basic-semibold'>{this.state.newPolMPremAmt.toLocaleString('it-IT', { style: 'currency', currency: 'VND' }).indexOf('VND') > 0 ? this.state.newPolMPremAmt.toLocaleString('it-IT', { style: 'currency', currency: 'VND' }).replace('VND', 'VNĐ'): (this.state.newPolMPremAmt.toLocaleString('it-IT', { style: 'currency', currency: 'VND' }) + ' VNĐ')} </p>
                                                            </div>
                                            ...
                                            <div className="tab">
                                                    ...
                                                    <div className="info__content-item">
                                                        <div className="input__content">
                                                            <div className="input disabled">
                                                                <div className="input__content">
                                                                    <label>Định kỳ đóng phí</label>
                                                                    <input type="search" maxLength="300" value={this.state.newFrequency} disabled/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="info__content-item">
                                                    <div className="input money disabled">
                                                        <div className="input__content">
                                                            <label>Phí định kỳ/cơ bản định kỳ (tạm tính)</label>
                                                            <NumberFormat className="basic-uppercase"
                                                                id='txtInputAmount'
                                                                value={this.state.polMPremAmt}
                                                                thousandSeparator={'.'} decimalSeparator={','}
                                                                suffix={' VNĐ'}
                                                                disabled
                                                            />
                                                ...
                                                <div className="info__content-item">
                                                    <div className="input money disabled">
                                                        <div className="input__content">
                                                            ...
                                                            <NumberFormat className="basic-uppercase"
                                                                id='txtInputAmount'
                                                                value={this.state.newPolMPremAmt}
                                                                thousandSeparator={'.'} decimalSeparator={','}
                                                                suffix={' VNĐ'}
                                                                disabled
                                                            />
                    ...
                    <div className={(left > 250)?"bottom-btn nd13-padding-bottom36": "bottom-btn"} ref={this.inputRef}>
                        { this.props.stepName === FUND_STATE.UPDATE_INFO ? (
                            ...
                            (this.state.newFrequencyCode !== '') && !this.state.exceedMax ? (
