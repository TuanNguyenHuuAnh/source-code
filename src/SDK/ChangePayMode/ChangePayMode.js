...
import ChangePayModeWrapper from './ChangePayModeWrapper';

let fromNative = '';
class ChangePayMode extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        cpSaveLogSDK(`${fromNative?fromNative:'Web'}_${proccessType}_Open_${PageScreen.POL_TRANS_CHANGE_PAYMODE}`, this.state.apiToken, this.state.deviceId, this.state.clientId);
        trackingEvent(
            "Giao dịch hợp đồng",
            `${fromNative?fromNative:'Web'}_${proccessType}_Open_${PageScreen.POL_TRANS_CHANGE_PAYMODE}`,
            `${fromNative?fromNative:'Web'}_${proccessType}_Open_${PageScreen.POL_TRANS_CHANGE_PAYMODE}`,
            fromNative
        );
    }
    ...
    componentWillUnmount() {
        ...
        cpSaveLogSDK(`${fromNative?fromNative:'Web'}_${proccessType}_Close_${PageScreen.POL_TRANS_CHANGE_PAYMODE}`, this.state.apiToken, this.state.deviceId, this.state.clientId);
        trackingEvent(
            "Giao dịch hợp đồng",
            `${fromNative?fromNative:'Web'}_${proccessType}_Close_${PageScreen.POL_TRANS_CHANGE_PAYMODE}`,
            `${fromNative?fromNative:'Web'}_${proccessType}_Close_${PageScreen.POL_TRANS_CHANGE_PAYMODE}`,
        );
    }
