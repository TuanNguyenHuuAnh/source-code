...
import {formatFullName, getDeviceId, getSession, showMessage, trackingEvent, getUrlParameter, cpSaveLogSDK} from '../../util/common';
...
class PaymodePolList extends Component {
    constructor(props) {
        super(props);
        this.state = {
