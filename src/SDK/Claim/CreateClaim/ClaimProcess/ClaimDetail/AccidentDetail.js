...
import { removeAccents, haveCheckedDeadth, isCheckedOnlyHC_HS, validAccidentDate, scrollUpFraction } from '../../../../sdkCommon';
    ...
    return (
      <div className="info sectab">
        ...
        <div className="info__body">
                  ...
                  <div className="datetime-wrapper" style={{ paddingBottom: '8px' }}>
                    ...
                    <div className="datetime-wrapper__item">
                      <div className={!accidentInfo.date && (accidentInfo.errors.errorList.indexOf('date') >= 0) ? "inputdate validate" : "inputdate"}>
                        ...
                        <DatePicker 
                        onOpenChange={(open) => {
                          if (open) scrollUpFraction();
                        }}
                        placeholder="Ngày" id='accident_date' value={accidentInfo.date ? moment(accidentInfo.date) : ""} disabledDate={disabledDate} onChange={(value) => this.handlerOnChangeDate(value)} format="DD/MM/YYYY" style={{ width: '100%', margin: '0px', padding: '0px', fontSize: '1.4rem' }} />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="item">
            <h5 className="item__title">Nơi xảy ra tai nạn</h5>
                    ...
                    <div className="checkbox-item">
                      <div className="round-checkbox">
                        <label className="customradio">
                            <input type="radio" checked={(this.props.isVietnam !== null) && this.props.isVietnam} onClick={() => this.props.inVietNam()}/>
                ...
                <div className="tab__content">
                  <div className="checkbox-warpper">
                    <div className="checkbox-item">
                      <div className="round-checkbox">
                        <label className="customradio">
                            <input type="radio" checked={(this.props.isVietnam !== null) && !this.props.isVietnam} onClick={() => this.props.notInVietNam()}/>
                            <div className={"checkmark"}></div>
                            <p className="text">Nước ngoài</p>
                        </label>
                      </div>
                    </div>
                  </div>
                ...
                <div className="tab__content" style={{padding:'0', marginBottom: '-4px'}}>
                  <div className="checkbox-warpper">
                    <div className="checkbox-item">
                      <div className="round-checkbox">
                        <label className="customradio" >
                          <input type="radio" id='accident_isVietnam' checked={(this.props.isVietnam !== null) && this.props.isVietnam} onClick={() => this.props.inVietNam()}/>
                          <div className={"checkmark"}></div>
                          <p className="text">Việt Nam</p>
                        </label>
                      </div>
                ...
                {(this.props.isVietnam !== null) && this.props.isVietnam &&
                  <>
                    <div className="dropdown inputdropdown">
                      <div className="dropdown__content">
                        <div className="tab__content">
                          <div className={!accidentInfo.districtCode && (accidentInfo.errors.errorList.indexOf('districtName') >= 0) ? "input validate" : "input"} style={{ padding: '10px 0px 10px 0px' }}>
                            <Select
                              suffixIcon={<SearchOutlined />}
                              showSearch
                              size='large'
