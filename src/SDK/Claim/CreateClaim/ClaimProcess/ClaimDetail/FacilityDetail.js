...
import {removeAccents, validFacilityDate} from '../../../../sdkCommon';
import {CLAIM_TYPE, FE_BASE_URL, OTHER_HOSPITAL} from '../../../../sdkConstant';
...
class FacilityDetail extends Component {
  ...
  onChangeTreatmentType(event) {
    if (event.target.checked) {
      let pFacilityDetail = Object.assign({}, this.props.facilityDetail);
      if (['DENT', 'OUT'].indexOf(event.target.value) >= 0) {
        pFacilityDetail['endDate'] = undefined;
      }
  ...
  render() {
    ...
    //Remove CSYT Khác in dropdown list
              ...
              {!fDetail.otherHospital ? (
                <div className="dropdown inputdropdown">
                  <div className="dropdown__content">
                    <div className="tab__content">
                      <div className={!fDetail.selectedHospital && fDetail.errors.errorList && ((fDetail.errors.errorList.indexOf('cityName') >= 0) || (fDetail.errors.errorList.indexOf('districtName') >= 0)) ? "input validate" : (((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit) && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")} style={{ padding: '8px 0px 10px 0px' }}>
                        <AutoComplete
                ...
                <>
                  <div className="dropdown inputdropdown">
                    <div className="dropdown__content">
                      <div className="tab__content">
                        <div className={(this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input"} style={{ padding: '8px 0px 10px 0px' }}>
                          <AutoComplete
                            suffixIcon={<SearchOutlined />}
                            showSearch
                            size='large'
                  ...
                  <div className="dropdown inputdropdown">
                    <div className="dropdown__content">
                      <div className="tab__content">
                        ...
                        <div className={!fDetail.cityName && (fDetail.errors.errorList.indexOf('cityName') >= 0) ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")} style={{ padding: '10px 0px 10px 0px' }}>
                          <Select
                            suffixIcon={<SearchOutlined />}
                            showSearch
                            size='large'
                  ...
                  <div className="dropdown inputdropdown">
                    <div className="dropdown__content">
                      <div className="tab__content">
                        <div className={!fDetail.selectedHospital && (fDetail.errors.errorList.indexOf('selectedHospital') >= 0) ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}>
                    ...
                    <div className="round-checkbox">
                      <label className="customradio">
                        <input type="radio" value="IN"
                          ...
                          disabled={(this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)}
                        />
                        <div className={(this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"checkmark-readonly":"checkmark"}></div>
              ...
              {(fDetail.treatmentType === 'IN') &&
                <div className="datewrapper">
                  <div className="datewrapper__item">
                    <div className={!fDetail.startDate && (fDetail.errors.errorList.indexOf('startDate') >= 0)?"inputdate validate":((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"inputdate disabled":"inputdate")}>
                      ...
                      <DatePicker placeholder="Từ ngày" disabled={(this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)} disabledDate={disabledStartDate} id={'facility_startDate_' + this.props.facilityIndex} value={fDetail.startDate ? moment(fDetail.startDate) : ""} onChange={(value) => this.handlerOnChangeDate("startDate", value)} format="DD/MM/YYYY" style={{ width: '100%', margin: '0px', padding: '0px', fontSize: '1.4rem' }}/>
                    </div>
                  </div>
                  <div className="line"></div>
                  <div className="datewrapper__item">
                    <div className={!fDetail.endDate && (fDetail.errors.errorList.indexOf('endDate') >= 0)?"inputdate validate":((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"inputdate disabled":"inputdate")}>
                      ...
                      <DatePicker placeholder="Đến ngày" disabled={(this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)} disabledDate={disabledStartDate} id={'facility_endDate_' + this.props.facilityIndex} value={fDetail.endDate ? moment(fDetail.endDate) : ""} onChange={(value) => this.handlerOnChangeDate("endDate", value)} format="DD/MM/YYYY" style={{ width: '100%', margin: '0px', padding: '0px', fontSize: '1.4rem' }} />
                    </div>
                  </div>
                </div>
              }
                  ...
                  <div className="datewrapper__item" style={{ width: '100%' }}>
                    <div className={!fDetail.startDate && (fDetail.errors.errorList.indexOf('startDate') >= 0)?"inputdate validate":((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"inputdate disabled":"inputdate")}>
                      ...
                      {/* <input type='date'
                        ...
                        value={fDetail.startDate} onChange={(event) => this.handlerOnChangeDate("startDate", event)} /> */}
                      <DatePicker placeholder="Ngày khám/ điều trị" disabled={(this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)} disabledDate={disabledStartDate} id={'facility_startDate_' + this.props.facilityIndex} value={fDetail.startDate ? moment(fDetail.startDate) : ""} onChange={(value) => this.handlerOnChangeDate("startDate", value)} format="DD/MM/YYYY" style={{ width: '100%', margin: '0px', padding: '0px', fontSize: '1.4rem' }} />
                    </div>
                  </div>
                </div>
              }
                      ...
                      <div className="tab__content">
                        <div className={!fDetail.invoiceList[index].invoiceAmount && invoice.errorList && (invoice.errorList.indexOf('invoiceAmount') >= 0) ? "input validate" : "input"}>
                          <div className="input__content">
                            ...
                            <NumberFormat displayType="input" type="tel" value={fDetail.invoiceList[index].invoiceAmount} prefix=""
                  ...
                  <div className="tab">
                    ...
                    <div className="tab__content">
                      <div className="input disabled">
                        <div className="input__content">
                          <label>Số tiền</label>
                          <NumberFormat displayType="input" type="tel" prefix=""                            
                            value={totalAmount}
                            thousandsGroupStyle="thousand" thousandSeparator={'.'}
                            decimalSeparator="," decimalScale="0" suffix={' VNĐ'} allowNegative={false}
                            disabled
          ...
          <div className="popup option-popup  show">
            <div className="popup__card">
              <div className="optioncard" style={{ lineHeight: '20px', paddingBottom: '0px' }}>
                ...
                <i className="closebtn option-closebtn"><img src={FE_BASE_URL + "/img/icon/close.svg"} alt="" onClick={() => cancelDeleteInvoice()} /></i>
              </div>
            </div>
