...
import {OTHER_HOSPITAL, FE_BASE_URL} from '../../../../sdkConstant';
import {removeAccents, validSickDate} from '../../../../sdkCommon';
                    ...
                    <div className="info">
                                    ...
                                    <div className="item__content">
                                        <div className="tab">
                                            <div className="tab__content">
                                                <div
                                                    className={(this.props.sickInfo.errors.dateValid.length > 0) || (!this.props.sickInfo.sickFoundTime && this.props.claimDetailState.sickInfo.errors.errorList && this.props.claimDetailState.sickInfo.errors.errorList.indexOf('sickFoundTime') >= 0) ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}>
                                ...
                                <div className="item">
                                    ...
                                    <div className="item__content">
                                        <div className="tab">
                                            <div className="tab__content">
                                                <div
                                                    className={(!this.props.sickInfo.firstSympton || (this.props.sickInfo.firstSympton.trim().length === 0)) && this.props.claimDetailState.sickInfo.errors.errorList && this.props.claimDetailState.sickInfo.errors.errorList.indexOf('firstSympton') >= 0 ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}>
                                            ...
                                            {!sickInfo.sickFoundFacilityOther ? (
                                                <div className="dropdown inputdropdown">
                                                    <div className="dropdown__content">
                                                        <div className="tab__content">
                                                            <div
                                                                className={!sickInfo.sickFoundFacility && sickInfo.errors.errorList && ((sickInfo.errors.errorList.indexOf('cityName') >= 0) || (sickInfo.errors.errorList.indexOf('districtName') >= 0)) ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}
                                                ...
                                                <>
                                                    <div className="dropdown inputdropdown">
                                                        <div className="dropdown__content">
                                                            <div className="tab__content">
                                                                <div
                                                                    className={sickInfo.errors.errorList && ((sickInfo.errors.errorList.indexOf('cityName') >= 0) || (sickInfo.errors.errorList.indexOf('districtName') >= 0)) ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}
                                                                    style={{padding: '8px 0px 10px 0px'}}>
                                                                    <AutoComplete
                                                                        suffixIcon={<SearchOutlined/>}
                                                                        showSearch
                                                    ...
                                                    <div className="dropdown inputdropdown">
                                                        <div className="dropdown__content">
                                                            <div className="tab__content">
                                                                ...
                                                                <div
                                                                    className={sickInfo.errors.errorList.indexOf('cityName') >= 0 ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}
                              ...
                              Vui lòng chọn tỉnh/ Thành phố
                                                    ...
                                                    <div className="dropdown inputdropdown">
                                                        <div className="dropdown__content">
                                                            <div className="tab__content">
                                                                <div
                                                                    className={sickInfo.errors.errorList.indexOf('sickFoundFacility') >= 0 ? "input validate" : ((this.props.disableEdit && !this.props.agentKeyInPOSelfEdit)?"input disabled":"input")}>
                        ...
                        <div className="info__body">
                            ...
                            <button className="circle-btn" onClick={this.handlerAddFacility}
                                    style={{marginTop: '12px', marginLeft: '-7px', paddingBottom:'20px'}}>
                    ...
                    <div className="popup option-popup  show">
                        <div className="popup__card">
                            <div className="optioncard" style={{lineHeight: '20px', paddingBottom: '0px'}}>
                                ...
                                <i className="closebtn option-closebtn"><img src={FE_BASE_URL + "/img/icon/close.svg"} alt=""
