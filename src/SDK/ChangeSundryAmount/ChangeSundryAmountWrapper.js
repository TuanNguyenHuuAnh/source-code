...
import ChangeSundryPolList  from './ChangeSundryPolList';
...
import SundryAmountDetail from './SundryAmountDetail';

export const ProcessType = "SundryAmountS";
...
class ChangeSundryAmountWrapper extends Component {
    constructor(props) {
        super(props);
    ...
    updateNoValidPolicy = (value) => {
        ...
        this.props.handlerUpdateNoValidPolicy(value);
    }
    ...
    render() {
        ...
        const showCardInfo = (polID, PolicyLIName, Frequency, PolMPremAmt, IsChangeFrequency, PolicyClassCD, FrequencyCode, PolSndryAmt, IsDegrading, PolSndryAmtMax) => {
            const jsonState = this.state;
            ...
            jsonState.PolSndryAmtMax = PolSndryAmtMax;
                    ...
                    {this.state.stepName === FUND_STATE.CHOOSE_POLICY ? (
                        ...
                        ((this.state.stepName === FUND_STATE.UPDATE_INFO) || (this.state.stepName === FUND_STATE.VERIFICATION) || (this.state.stepName === FUND_STATE.SDK)) && (
                            <SundryAmountDetail 
                                ...
                                PolSndryAmtMax = {this.state.PolSndryAmtMax}
                            ...
                            <div className='paymode-margin-bottom' style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                                <div className="bottom-text"
                                    ...
                                    <p style={{textAlign: 'justify'}}>
                                        ...
                                        style={{color: '#727272'}}>
                                        Yêu cầu này chỉ áp dụng với Hợp đồng đang hiệu lực (sản phẩm bảo hiểm Liên kết đầu tư và Hưu trí).
                                        </span>
                                    </p>
                                </div>
                            </div>
...
export default ChangeSundryAmountWrapper;