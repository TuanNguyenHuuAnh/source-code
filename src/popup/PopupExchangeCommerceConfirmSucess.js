...
class PopupExchangeCommerceConfirmSucess extends Component {
  constructor(props) {
    super(props);
  ...
  closeExchangeMobileCardSuccess = () => {
    document.getElementById('exchange-ecommerce-popup-success').className = "popup refund-confirm-popup special";
    this.props.resetSelected(false);
  }
  render() {
    ...
    return (
      <div className="popup refund-confirm-popup special" id="exchange-ecommerce-popup-success">
          ...
          <div className="refund-confirm-card">
            ...
            <div className="content">
              <p style={{paddingBottom: '1px'}}>
                Quý khách đã chọn đổi <span className="basic-red basic-bold special">{formatMoney(this.props.usePoint)} điểm thưởng</span> thành
                <span className="basic-bold">&nbsp;<span className="basic-red basic-bold special">{this.props.qty}</span> {this.props.shortDescription}</span>
              </p>
              ...
              <Link to={"/category/" + this.props.categorycd} onClick={this.closeExchangeMobileCardSuccess} style={{marginTop: '-3px'}}>
...
export default PopupExchangeCommerceConfirmSucess;