...
class PopupChangePassSucc extends Component {
  constructor(props) {
    super(props);
  ...
  closeThanks = () => {
    document.getElementById('popup-change-pass-succ').className = "popup special envelop-confirm-popup";
  }
  render() {

    return (
      <div className="popup special envelop-confirm-popup" id="popup-change-pass-succ">
...
export default PopupChangePassSucc;