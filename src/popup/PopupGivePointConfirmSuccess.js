...
class PopupGivePointConfirmSuccess extends Component {
  constructor(props) {
    super(props);
  ...
  closeRefundConfirmSuccess = () => {
    document.getElementById('give-point-confirm-popup-success').className = "popup refund-confirm-popup special";
  }
  render() {
    ...
    return (
      <div className="popup refund-confirm-popup special" id="give-point-confirm-popup-success">
          ...
          <div className="refund-confirm-card">
            ...
            <div className="content">
              <p style={{paddingBottom: '1px'}}>
                Quý khách đã chọn đổi <span className="basic-red basic-bold special">{formatMoney(this.props.totalPoint)} điểm thưởng</span>
                &nbsp;tặng cho hợp đồng: <span className="basic-bold">{this.props.polID}</span>
              </p>
...
export default PopupGivePointConfirmSuccess;