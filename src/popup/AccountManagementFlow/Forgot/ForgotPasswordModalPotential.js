...
import '../styles.css';
import {getPointByClientID, logoutSession, removeUndefinedFields, signup} from '../../../util/APIUtils';
import {buildParamsAndRedirect, getLinkId, getDeviceId, getSession, removeAccents, setSession, showMessage, roundDown, getLinkPartner, formatTime} from '../../../util/common';
import {
    API_TOKEN,
    AUTHENTICATION,
    COMPANY_KEY,
...
const ForgotPasswordModalPotential = (props) => {
...
export default ForgotPasswordModalPotential;
