...
import '../styles.css';
import {signup, verifyOTP} from '../../../util/APIUtils';
import {getDeviceId, getSession, removeAccents, setSession, showMessage, formatTime, removeSpecialCharactersAndSpace, trackingEventAsTemplate} from '../../../util/common';
import {
    API_TOKEN,
    AUTHENTICATION,
    COMPANY_KEY,
...
const ForgotUsernameModalPO = (props) => {
...
export default ForgotUsernameModalPO;
