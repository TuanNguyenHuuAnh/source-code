...
class PopupAccountPOExisted extends Component {
    constructor(props) {
        super(props);
    ...
    closeRestorePass = () => {
        // document.getElementById('restore-password').className = "popup option-popup";
        this.props.closePopupAccountPOExisted();
    }
            ...
            <div className="popup option-popup show">
                <div className="popup__card">
                    <div className="optioncard">
                        <p>Quý khách đã có tài khoản với công ty Dai-ichi Life Việt Nam. Vui lòng khôi phục thông tin đăng nhập hoặc sử dụng tính năng <b>Đăng nhập</b> để tiếp tục.</p>
                        <div className="btn-wrapper">
                            <button className="btn btn-primary" id="existed" onClick={() => this.props.forgotForgotBothModalPO()}>Khôi phục thông tin đăng nhập</button>
                ...
                {this.state.showOtp && this.props.isOpenPopup &&
...
export default PopupAccountPOExisted;