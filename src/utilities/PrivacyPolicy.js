...
const PrivacyPolicy = () => {
    ...
    return (<main className={mainClass}>
        {state.renderMeta && <Helmet>
            <title>Chính sách bảo mật thông tin – Dai-ichi Life Việt Nam</title>
            <meta name="description"
                  content="Trang thông tin về Chính sách bảo mật thông tin Khách hàng từ Dai-ichi Life Việt Nam."/>
            <meta name="keywords" content="bảo mật thông tin, quyền riêng tư, bảo hiểm, bảo hiểm nhân thọ, dai-ichi life, bí quyết sống vui khỏe, chạy bộ, tập luyện thể thao, hợp đồng bảo hiểm, yêu cầu hỗ trợ, giải quyết quyền lợi, thay đổi thông tin, người được bảo hiểm, chủ hợp đồng" />
            <meta name="robots" content="noindex, nofollow"/>
            <meta property="og:type" content="website"/>
            <meta property="og:url" content={FE_BASE_URL + "/privacy-policy"}/>
            <meta property="og:title" content="Chính sách bảo mật thông tin – Dai-ichi Life Việt Nam"/>
            ...
            <link rel="canonical" href={FE_BASE_URL + "/privacy-policy"}/>
        </Helmet>}
                                            ...
                                            <div className="dieukhoanform">
                                                ...
                                                <div className="dieukhoanform__body">
                                                    <div className="dieukhoanform__body-text">
                                                        ...
                                                        <p className="dieukhoanform__subContent no-dot">
															Nếu có bất kỳ thắc mắc hoặc yêu cầu nào liên quan tới Chính sách bảo mật thông tin, Bạn vui lòng liên hệ tới Dai-ichi Life Việt Nam thông qua các hình thức sau đây để được hỗ trợ:
                                                        </p>
                                                        <p className="dieukhoanform__subContent dot">
                                                            •	Đường dây nóng: phục vụ các ngày từ 08:00 - 17:30, trừ các ngày nghỉ lễ, Tết<br/>
															<span style={{fontWeight: '500', marginLeft: '16px'}}>
																o	(028) 3810 0888 - Bấm phím 1<br/>
															</span>
                                                            <span style={{fontWeight: '500', marginLeft: '16px'}}>
																o	(028) 7308 8880 - Bấm phím 1
															</span>
                                                        </p>
                                                        <p className="dieukhoanform__subContent">
