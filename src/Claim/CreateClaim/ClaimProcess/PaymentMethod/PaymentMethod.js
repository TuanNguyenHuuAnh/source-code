...
import { ACCESS_TOKEN, CLIENT_ID, USER_LOGIN, FULL_NAME, POID, AUTHENTICATION, COMPANY_KEY, CLAIM_TYPE, DOB, CELL_PHONE, EMAIL, ADDRESS } from '../../../../constants';
import { getSession, is18Plus, formatDate, onlyLettersAndSpaces, getDeviceId } from '../../../../util/common';
import { INITIAL_STATE, CLAIM_STATE, PAYMENT_METHOD_CASE, PAYMENT_METHOD_STEP } from '../../CreateClaim';
...
class PaymentMethod extends Component {
  ...
  componentDidMount() {
    ...
    if (!jsonState.paymentMethodState.goneInPaymentMethod) {
      if (this.props.claimCheckedMap[CLAIM_TYPE.DEATH]) {
        ...
        if ((this.props.claimCheckedMap[CLAIM_TYPE.TPD] || this.props.claimCheckedMap[CLAIM_TYPE.ILLNESS] || this.props.claimCheckedMap[CLAIM_TYPE.ACCIDENT]) && (this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && is18Plus(this.props.selectedCliInfo.DOB)) {
          jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName = this.props.selectedCliInfo.FullName;
          // alert('aa=' + jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName);
          jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverName = this.props.selectedCliInfo.FullName;
          jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverPin = this.props.selectedCliInfo.POID ? this.props.selectedCliInfo.POID.trim() : '';
          jsonState.paymentMethodState.paymentMethodCase = PAYMENT_METHOD_CASE.FULL_ABOVE_18;
        } else if ((this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && is18Plus(this.props.selectedCliInfo.DOB)) {
          // alert('e');
          jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName = this.props.selectedCliInfo.FullName;
          jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverName = this.props.selectedCliInfo.FullName;
          jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverPin = this.props.selectedCliInfo.POID ? this.props.selectedCliInfo.POID.trim() : '';
          jsonState.paymentMethodState.paymentMethodCase = PAYMENT_METHOD_CASE.HC_HS_ABOVE_18;
        } else if (this.props.claimCheckedMap[CLAIM_TYPE.TPD] || this.props.claimCheckedMap[CLAIM_TYPE.ILLNESS] || this.props.claimCheckedMap[CLAIM_TYPE.ACCIDENT] || !is18Plus(this.props.selectedCliInfo.DOB)) {
          // alert('d');
          ...
          jsonState.paymentMethodState.lifeBenState.cashTypeState.receiverPin = this.props.selectedCliInfo.POID ? this.props.selectedCliInfo.POID.trim() : '';
        ...
        if ((this.props.claimCheckedMap[CLAIM_TYPE.TPD] || this.props.claimCheckedMap[CLAIM_TYPE.ILLNESS] || this.props.claimCheckedMap[CLAIM_TYPE.ACCIDENT]) && (this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && is18Plus(this.props.selectedCliInfo.DOB)) {
          jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName = getSession(FULL_NAME) ? getSession(FULL_NAME).trim() : "";
          // alert(jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName);
          jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverName = getSession(FULL_NAME) ? getSession(FULL_NAME).trim() : "";
          jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverPin = getSession(POID) ? getSession(POID).trim() : "";
          jsonState.paymentMethodState.paymentMethodCase = PAYMENT_METHOD_CASE.FULL_ABOVE_18;
        } else if ((this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && is18Plus(this.props.selectedCliInfo.DOB)) {
    ...
    // jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName = selectedCliInfo.FullName ? selectedCliInfo.FullName.trim() : "";
    // jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverName = selectedCliInfo.FullName ? selectedCliInfo.FullName.trim() : "";
    // jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverPin = selectedCliInfo.POID ? selectedCliInfo.POID.trim() : "";
  ...
  updateState(jsonState) {
    ...
    if ((this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && !this.props.claimCheckedMap[CLAIM_TYPE.DEATH] && is18Plus(this.props.selectedCliInfo.DOB)) {
    ...
    if (value) {
      ...
      if (benefitType !== null) {
        ...
        if (paymentMethodCase === PAYMENT_METHOD_CASE.FULL_ABOVE_18) {
          if (!this.props.paymentMethodState.choseReceiver) {
          ...
          if ((this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && (paymentMethodCase !== PAYMENT_METHOD_CASE.CLAIM_LIFE_OR_HC_HS_UNDER_18)) {
            jsonState.paymentMethodState.healthCareBenState[transferMethod].receiverPinDate = value;
          }
        }
      }
  ...
  onChangePaymentMethod(benefitType, paymentMethodCase, event) {
    if (event.target.checked) {
      ...
      //   jsonState.paymentMethodState.lifeBenState.transferTypeState.bankAccountName = this.props.selectedCliInfo.FullName;
      //   jsonState.paymentMethodState.lifeBenState.cashTypeState.receiverName = this.props.selectedCliInfo.FullName;
      //   jsonState.paymentMethodState.lifeBenState.cashTypeState.receiverPin = this.props.selectedCliInfo.POID;
      // }
      if (benefitType !== null) {
  ...
  onChangeChooseReceiver(event) {
    ...
    if (this.props.claimCheckedMap[CLAIM_TYPE.DEATH]) {
      ...
      //   jsonState.paymentMethodState.lifeBenState.cashTypeState.receiverPin = this.props.selectedCliInfo.POID;
      // }
      if ((this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) && is18Plus(this.props.selectedCliInfo.DOB)) {
        jsonState.paymentMethodState.healthCareBenState.transferTypeState.bankAccountName = this.props.selectedCliInfo.FullName;
        jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverName = this.props.selectedCliInfo.FullName;
        jsonState.paymentMethodState.healthCareBenState.cashTypeState.receiverPin = this.props.selectedCliInfo.POID;
      ...
      if (value === 'PO' && jsonState.paymentMethodState.paymentMethodCase === PAYMENT_METHOD_CASE.FULL_ABOVE_18) {
        ...
        if (this.props.claimCheckedMap[CLAIM_TYPE.TPD] || this.props.claimCheckedMap[CLAIM_TYPE.ILLNESS] || this.props.claimCheckedMap[CLAIM_TYPE.ACCIDENT] || !is18Plus(this.props.selectedCliInfo.DOB)) {
          jsonState.paymentMethodState.lifeBenState.transferTypeState.bankAccountName = getSession(FULL_NAME) ? getSession(FULL_NAME).trim() : "";
          jsonState.paymentMethodState.lifeBenState.cashTypeState.receiverName = getSession(FULL_NAME) ? getSession(FULL_NAME).trim() : "";
          jsonState.paymentMethodState.lifeBenState.cashTypeState.receiverPin = getSession(POID) ? getSession(POID).trim() : "";
        }
    ...
    if (value === 'PO') {
      ...
      contactState.contactPersonInfo.fullName = this.props.selectedCliInfo.FullName ? this.props.selectedCliInfo.FullName : '';
      contactState.contactPersonInfo.pin = this.props.selectedCliInfo.POID ? this.props.selectedCliInfo.POID : '';
      contactState.contactPersonInfo.dob = this.props.selectedCliInfo.DOB ? this.props.selectedCliInfo.DOB : '';
      contactState.contactPersonInfo.phone = this.props.selectedCliInfo.CellPhone ? this.props.selectedCliInfo.CellPhone : '';
      contactState.contactPersonInfo.email = this.props.selectedCliInfo.Email ? this.props.selectedCliInfo.Email : '';
      contactState.contactPersonInfo.address = this.props.selectedCliInfo.Address ? this.props.selectedCliInfo.Address : '';
    }
    this.updateState(jsonState);
  ...
  render() {
    ...
    const back = (stepName) => {
      ...
      if ((jsonState.paymentMethodState.paymentMethodStep === PAYMENT_METHOD_STEP.INIT) && jsonState.paymentMethodState.choseReceiver) {
        ...
        this.props.handlerBackToPrevStep(stepName);
      }
    }
    const goBack = () => {
      ...
      <section className="sccontract-warpper" id="scrollAnchor">
        <div className="insurance">
              ...
              <div className="step-container">
                <div className="step-wrapper">
                  <div className="step-btn-wrapper">
                    <div className="back-btn" onClick={() => back(this.state.stepName)}>
                      <button>
            ...
            <div className="stepform__body">
              ...
              {(this.props.claimCheckedMap[CLAIM_TYPE.DEATH]) ? (
                              ...
                              <div className="checkbox-dropdown__content-item">
                                <div className="input">
                                  <div className="input__content">
                                    ...
                                    <NumberFormat displayType="input" type="search" maxLength="20" value={lifeBenTransferState.bankAccountNo} prefix=""
                ...
                is18Plus(this.props.selectedCliInfo.DOB) ? (
                  (this.props.claimCheckedMap[CLAIM_TYPE.TPD] || this.props.claimCheckedMap[CLAIM_TYPE.ILLNESS] || this.props.claimCheckedMap[CLAIM_TYPE.ACCIDENT]) && (this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE] || this.props.claimCheckedMap[CLAIM_TYPE.HS]) ? (
                    ...
                    (this.props.paymentMethodState.paymentMethodStep === PAYMENT_METHOD_STEP.INIT) ? (
                      ...
                      !this.props.paymentMethodState.choseReceiver && !this.props.claimTypeState.isSamePoLi ? (
                        <div className="info">
                          <div className="info__title">
                            <h4>Phương thức thanh toán</h4>
                          </div>
                                                ...
                                                <div className="checkbox-dropdown__content-item">
                                                  <div className="input disabled">
                                                    <div className="input__content">
                                                      ...
                                                      <input type="search" placeholder="Số tài khoản" maxLength="20" value={lifeBenTransferState.bankAccountNo}
                                                        disabled />
                                                    </div>
                                                    <i><img src="../../img/icon/edit.svg" alt="" /></i>
                                                  </div>
                                            ...
                                            <div className="checkbox-dropdown__content-item">
                                              <div className="input">
                                                <div className="input__content">
                                                  ...
                                                  <NumberFormat displayType="input" type="search" maxLength="20" value={healthCareBenTransferState.bankAccountNo} prefix=""
                                                    placeholder="Số tài khoản"
                                                    allowNegative={false}
                                                    allowLeadingZeros={true}
                    ...
                    (this.props.claimCheckedMap[CLAIM_TYPE.TPD] || this.props.claimCheckedMap[CLAIM_TYPE.ILLNESS] || this.props.claimCheckedMap[CLAIM_TYPE.ACCIDENT]) ? (
          ...
          <div className="bottom-btn">
            <button className={(jsonState.paymentMethodState.disabledButton || disable || (!lifeBenState.paymentMethodId && !healthCareBenState.paymentMethodId)) ? "btn btn-primary disabled" : "btn btn-primary"}
              id="submitClaimDetail" disabled={!!(jsonState.paymentMethodState.disabledButton || disable || (!lifeBenState.paymentMethodId && !healthCareBenState.paymentMethodId))}
              onClick={this.props.handlerSubmitPaymentMethod}>Tiếp tục</button>
          </div>
        </div>
      </section>
    );
