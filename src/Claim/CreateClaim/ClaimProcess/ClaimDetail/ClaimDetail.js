...
import { ACCESS_TOKEN, CLIENT_ID, USER_LOGIN, AUTHENTICATION, COMPANY_KEY, CLAIM_TYPE } from '../../../../constants';

import { CLAIM_STATE, INITIAL_STATE } from '../../CreateClaim';
...
import { getSession, isCheckedOnlyDeadth, haveCheckedDeadth, isCheckedOnlyHC_HS, validDeathDate, validAccidentDate, validSickDate, validFacilityDate, getDeviceId } from '../../../../util/common';
...
class ClaimDetail extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      stepName: CLAIM_STATE.CLAIM_DETAIL,
      ...
      if (this.props.claimDetailState.isTreatmentAt === true) {
        ...
        if (this.props.claimCheckedMap[CLAIM_TYPE.HEALTH_CARE]) {
          if (facility.invoiceList) {
            for (const invoice of facility.invoiceList) {
              invoice.errorList = [];
              // if (!invoice.InvoiceNumber || !invoice.InvoiceAmount) {
              //   invoice.errorList.push()
              // }
        ...
        <div className="insurance">
              ...
              <div className="step-container">
                <div className="step-wrapper">
                  <div className="step-btn-wrapper">
                    <div className="back-btn" onClick={() => showConfirmClear()}>
                      <button>
                  ...
                  <div className="progress-bar">
                    ...
                    <div className={(this.state.stepName === CLAIM_STATE.PAYMENT_METHOD) || (this.state.stepName === CLAIM_STATE.CONTACT) ? "step active" : "step"}>
                      <div className="bullet">
                        <span>2</span>
                      </div>
                  ...
                  <div className="step-btn-save-quit">
                    <div>
                      <button onClick={this.props.handleSaveLocalAndQuit}>
          ...
          <div className="stepform" id="scrollAnchor">
            {/* <div className="stepform__head">
              <h3 className="stepform__head-title">THÔNG TIN SỰ KIỆN</h3>
              <div className="checkbox-wrap">
                <div className="checkbox-warpper-step1-1">
                  <label className="checkbox2">
                    <input type="checkbox" checked={!!claimTypeState.isSickClaim} disabled={true} />
                ...
                <div className="checkbox-warpper-step1-1">
                  <label className="checkbox2">
                    <input type="checkbox" checked={!!claimTypeState.isAccidentClaim} disabled={true} />
                    <div className="checkmark">
                      <img src="../../img/icon/check.svg" alt="" />
                    </div>
                  </label>
                  <p claas="text">Tai nạn</p>
                </div>
                <div className="checkbox-warpper-step1-1">
                  <label className="checkbox2">
                    <input type="checkbox" checked={!!claimTypeState.isDeathClaim} disabled={true} />
                    <div className="checkmark">
                      <img src="../../img/icon/check.svg" alt="" />
                    </div>
                  </label>
                  <p claas="text">Tử vong</p>
                </div>
              </div>
            </div> */}
          ...
          {/* <div className="optional-checkbox-wrapper">
            <h5 className="basic-semibold">Sự kiện bảo hiểm cũng được yêu cầu quyền lợi tại Công ty bảo hiểm khác</h5>
            <div className="checkbox-warpper">
              <div className="checkbox-item">
                <div className="round-checkbox">
                  <label className="customradio">
                    <input type="radio" value="yes"
                      checked={claimDetailState.isOtherCompanyRelated === "yes"}
                      onChange={() => this.handlerUpdateSubClaimDetailState("isOtherCompanyRelated", "yes")}
                    />
                ...
                <div className="round-checkbox">
                  <label className="customradio">
                    <input type="radio" value="no"
                      checked={claimDetailState.isOtherCompanyRelated === "no"}
                      onChange={() => this.handlerUpdateSubClaimDetailState("isOtherCompanyRelated", "no")}
                    />
                    <div className="checkmark"></div>
          ...
          {/* {(claimDetailState.isOtherCompanyRelated === 'yes') &&
            <OtherCompanyDetail
              otherCompanyInfoList={claimDetailState.otherCompanyInfoList}
              handlerUpdateSubClaimDetailState={this.handlerUpdateSubClaimDetailState} />
          } */}
          ...
          <div className="bottom-btn">
            <button className={(claimDetailState.disabledButton) ? "btn btn-primary disabled" : "btn btn-primary"}
              id="submitClaimDetail" disabled={!!(claimDetailState.disabledButton)} onClick={() => validateAndSubmit()}>Tiếp tục</button>
          </div>
        </div>
