...
import { removeAccents, validDeathDate } from '../../../../util/common';
...
class DeathDetail extends Component {
  ...
  onChangeCity(value) {
    ...
    if (cityObj !== null) {
      ...
      if(districtZZZ){
        pDeathInfo.districtCode = districtZZZ.DistrictCode;
        pDeathInfo.districtName = districtZZZ.DistrictName;
      }
      this.props.handlerUpdateSubClaimDetailState("deathInfo", pDeathInfo);
    }
  }
          ...
          <div className="item">
            ...
            <div className="item__content">
              <div className="tab">
                ...
                {/* Chọn quận/ huyện */}
                {(this.props.isVietnam !== null) && this.props.isVietnam && this.props.deathInfo.districtCode !== 'ZZZ' &&
                <div className="dropdown inputdropdown">
                  <div className="dropdown__content">
                    <div className="tab__content">
                      <div className={!deathInfo.districtName && (deathInfo.errors.errorList.indexOf('districtName') >= 0) && deathInfo.districtCode !='ZZZ' ? "input validate" : "input"} style={{ padding: '10px 0px 10px 0px' }}>
                        <Select
                          suffixIcon={<SearchOutlined />}
                          showSearch
                          size='large'
