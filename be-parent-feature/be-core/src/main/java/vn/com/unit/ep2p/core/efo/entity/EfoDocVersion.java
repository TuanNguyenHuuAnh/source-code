...
@Getter
@Setter
@Table(name = AppCoreConstant.TABLE_EFO_DOC_VERSION)
public class EfoDocVersion extends AbstractDocument{

	/** Column: ID type NUMBER (20,0) NOT NULL */
	@Id
	@Column(name = "ID")
	@PrimaryKey(generationType = GenerationType.SEQUENCE, generator = WorkflowConstant.SEQ + AppCoreConstant.TABLE_EFO_DOC_VERSION)
	private Long id;
