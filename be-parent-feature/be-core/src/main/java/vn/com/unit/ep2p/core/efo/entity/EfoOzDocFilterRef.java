...
@Getter
@Setter
@Table(name = CoreConstant.TABLE_EFO_OZ_DOC_FILTER_REF)
public class EfoOzDocFilterRef extends AbstractDocumentFilter {

    /** Column: ID type DECIMAL(20) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = CoreConstant.SEQ + CoreConstant.TABLE_EFO_OZ_DOC_FILTER_REF)
    private Long id;
    
    /** Column: UNREAD type NUMBER(1,0) null */
	@Column(name = "UNREAD")
	private boolean unread;

	
	/** Column: RELATED_TYPE type NVARCHAR2(255,0) null */
	@Column(name = "RELATED_TYPE")
	private String relatedType;

	
	/** Column: SUMMITTED_ID type NUMBER(20,0) null */
	@Column(name = "SUMMITTED_ID")
	...
	/** Column: RELATED_ID type NUMBER(20,0) null */
	@Column(name = "RELATED_ID")
	private Long relatedId;

	
	/** Column: RELATED_ORG_ID type NUMBER(20,0) null */
	@Column(name = "RELATED_ORG_ID")
	private Long relatedOrgId;

	
	/** Column: RELATED_POSITION_ID type NUMBER(20,0) null */
