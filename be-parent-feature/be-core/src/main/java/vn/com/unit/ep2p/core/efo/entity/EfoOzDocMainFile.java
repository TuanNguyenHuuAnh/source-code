...
@Getter
@Setter
@Table(name = CoreConstant.TABLE_EFO_OZ_DOC_MAIN_FILE)
public class EfoOzDocMainFile extends AbstractTracking {

    /** Column: ID type VARCHAR2(18)  NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = CoreConstant.SEQ + CoreConstant.TABLE_EFO_OZ_DOC_MAIN_FILE)
    private Long id;
