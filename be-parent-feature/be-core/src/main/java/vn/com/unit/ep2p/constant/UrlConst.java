...
public class UrlConst {
	...
	public static final String EMULATE_IMPORT = "emulate-import";
	public static final String EMULATE_RESULT = "emulate-result";
    public static final String EMULATE_RESULT_IMPORT = "emulate-result-import";
    public static final String FAQS_CATEGORY_IMPORT = "faqs-category-import";
	...
	/** AUTHORITY PROCESS */
	public static final String AUTHORITY_PROCESS = "/authority-process";
	public static final String AJAX_LOAD_PROCESS = "/ajax/load-process";
	...
	// private static final String URL_API_DOWNLOAD_PDF_ECM =
	// "api/v1/doc/download/pdf-ecm";
...
//	public static final String ABOUT_HDBANK = "about-hdbank";
...
//	public static final Long ABOUT_HDBANK = 11L;
	...
	public static final String URL_IMAGE = "?fileName=";
	...
	//TranLTH --- Tách promotion ra khỏi personal và corporate --- 17/04/2019	
	public static final String URL_PROMOTIONS = "/promotions";
	//---End---
	
    public static final String URL_UPLOADTEMP = "/uploadTemp";
    
    
    
	public static final String KEY_SECRET = "s3cr3t@uth3nt1c@t10n";
    public static final String URL_API_HDBANK = "/svHDAPI.svc/HDAPI";
    public static final String URL_API_SP_COFIRM_ACCOUNT = "/sp_XacThucTaiKhoanQuanTri";
...
//    public static final String CORPORATE = "corporate";
    ...
    /** URL INTERNETBANKING *///tranlth - 14/12/2018 - thêm mới link constant   
...
//    public static final String INTEREST_RATE = "interest-rate";
    ...
    public static final String INTEREST_RATE_TITLE = "interest-rate-title";
    
    public static final String INTEREST_RATE_VALUE = "interest-rate-value";
...
//    public static final String MENUHOME = "/menu-home";
    ...
    public static final String MENU_ADMIN_ROOT = ROOT + MENU_ADMIN;
...
//    public static final String HOLIDAY ="/holidays";
    ...
    public static final String AJAX_CHANGE_PW = "/ajax-change-password";
    public static final String REDIRECT_CHANGE_PW = "account/change-password";
...
//    public static final String TEMPLATE_EMAIL="/email/template";
    ...
    public static final String URL_INTRODUCTION_CATEGORY = "/introduction-category";
    
    public static final String URL_INVESTOR_CATEGORY = "investor-category";
	// CMS ALL

    
    // D-SUCCESS - CMS
    public static final String DOCUMENT_MANAGEMENT = "/document-management";
	public static final String NOTIFY_IMPORT_CONTROLLER = "/notify-import-controller";
}
