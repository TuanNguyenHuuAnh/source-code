  ...
  ,f_in.SUBMITTED_DATE				AS SUBMITTED_DATE
...
ON
  acc_submited.ID = f_in.SUBMITTED_ID
LEFT JOIN 
...
WHERE 
	...
	AND auth.ACCOUNT_ID = /*accountId*/1
  	/*IF efoDocumentFilterSearchDto.companyId !=null*/
  		AND doc.COMPANY_ID =/*efoDocumentFilterSearchDto.companyId*/1
  	/*END*/
  	/*IF efoDocumentFilterSearchDto.fromDate !=null*/
  		AND f_in.SUBMITTED_DATE >=/*efoDocumentFilterSearchDto.fromDate*/''
  	/*END*/
