...
public class AutoEventJob implements Job {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AutoEventJob.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            try {
                // Add auto event
            	HashMap<OfficeDto, EventsAdmin> events = eventsAdminService.addAutoEvent();
            	// Sendmail QrCode
            	eventsAdminService.sendMailQrCode(events);
            } catch (Exception e) {
                logger.error("##Error##" + e);
            }
            // ------END------
            
            System.out.println("CreateAutoEventJob run at: " + CommonDateUtil.formatDateToString(new Date(), CommonDateUtil.YYYYMMDDHHMMSSFFF));
            ...
            // Log error
            logger.error("## CreateAutoEventJob ##", e);
