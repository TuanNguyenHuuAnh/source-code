...
public class CleanupConfirmedDecreeJob implements Job {
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            try {
            	sannerService.updateAgentTERConfirmedDecree();  
            } catch (Exception e) {
                logger.error("##Error##" + e);
            }
            // ------END------
            
            System.out.println("CleanupConfirmedDecreeJob run at: " + CommonDateUtil.formatDateToString(new Date(), CommonDateUtil.YYYYMMDDHHMMSSFFF));
            ...
            // Log error
            logger.error("## CleanupConfirmedDecreeJob ##", e);
