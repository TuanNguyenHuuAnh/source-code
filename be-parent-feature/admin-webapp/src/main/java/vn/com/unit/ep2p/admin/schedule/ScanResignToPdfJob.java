...
import vn.com.unit.ep2p.admin.service.ScanResignToPdfService;
...
public class ScanResignToPdfJob implements Job{
    ...
    @Autowired
    private ScanResignToPdfService scanResignToPdfService;
    
    private static final Logger logger = LoggerFactory.getLogger(ScanResignToPdfJob.class);
    ...
    public void execute(JobExecutionContext context){
        ...
        try {
            ...
            int count = scanResignToPdfService.scanAndProcessPdfSignFail(companyId);
