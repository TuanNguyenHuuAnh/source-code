...
public class UpdateCandidateInActiveJob implements Job {
    ...
    @Autowired
    ScannerUpdateDBService sannerService;
    
    private static final Logger logger = LoggerFactory.getLogger(CleanupConfirmedDecreeJob.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            try {
            	sannerService.updateCandiateInOfficeInactive();  
            } catch (Exception e) {
                logger.error("##Error##" + e);
            }
            // ------END------
            
            System.out.println("UpdateCandidateInActiveJob run at: " + CommonDateUtil.formatDateToString(new Date(), CommonDateUtil.YYYYMMDDHHMMSSFFF));
            ...
            // Log error
            logger.error("## UpdateCandidateInActiveJob ##", e);
