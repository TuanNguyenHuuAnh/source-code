...
public class AutoRemoveDelegatorJob implements Job {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AutoRemoveDelegatorJob.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
           ...
           /* systemLogsService.writeSystemLogs(CommonConstant.SC1_S02_JOBSCHEDULE, job.getJobName() + " start", LogTypeEnum.INFO.toInt(),
            ...
            logger.info("##removeDelegatorForJob - before excute (QrtzMJobLog) : " + JsonUtils.convertObjectToJSON(jobLog));
            ...
            // Log error
            logger.error("##removeDelegatorForJob", e);
