...
public class DeleteAccountZoomJob implements Job {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DeleteAccountZoomJob.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            // ------push notify------
            try {
            	RetrofitUtils.deleteAccountZoom();
            } catch (Exception e) {
                logger.error("##Error##" + e);
            }
            // ------END------
            
            System.out.println("DeleteAccountZoomJob run at: " + CommonDateUtil.formatDateToString(new Date(), CommonDateUtil.YYYYMMDDHHMMSSFFF));
            ...
            // Log error
            logger.error("## DeleteAccountZoomJob ##", e);
