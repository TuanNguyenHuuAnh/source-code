...
/**
 * Reminder for ZD approval activity.
 * 
 * @version 01-00
 * @since 01-00
 * @author nt.tinh
...
public class NotifySamJob implements Job {
    ...
    @Autowired
	private SamAdminService service;
    
    private static final Logger logger = LoggerFactory.getLogger(NotifySamJob.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            // ------push notify------
            try {
            	service.pushNotificationForZD();
            } catch (Exception e) {
                logger.error("##Error##" + e);
            }
            // ------END------
            
            System.out.println("NotifySamJob run at: " + CommonDateUtil.formatDateToString(new Date(), CommonDateUtil.YYYYMMDDHHMMSSFFF));
