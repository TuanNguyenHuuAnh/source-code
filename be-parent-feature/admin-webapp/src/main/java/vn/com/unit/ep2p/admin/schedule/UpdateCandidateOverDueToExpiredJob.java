...
public class UpdateCandidateOverDueToExpiredJob implements Job {
    ...
    @Autowired
    ScannerUpdateDBService scannerService;
    
    private static final Logger logger = LoggerFactory.getLogger(UpdateCandidateOverDueToExpiredJob.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            try {
            	scannerService.updateCandidateOverDueToExpired();  
            } catch (Exception e) {
                logger.error("##Error##" + e);
            }
            // ------END------
            
            System.out.println("UpdateCandidateOverDueToExpiredJob run at: " + CommonDateUtil.formatDateToString(new Date(), CommonDateUtil.YYYYMMDDHHMMSSFFF));
            ...
            // Log error
            logger.error("## UpdateCandidateOverDueToExpiredJob ##", e);
