 ...
 * @author HungHT
 */
public interface SvcManagementService {   
     ...
     * @author HungHT
     */
    PageWrapper<SvcManagementDto> getSvcManagementList(SvcManagementSearchDto search, int pageSize, int page, String lang);
     ...
     * @author HungHT
     */
    void initScreenDetail(ModelAndView mav, SvcManagementDto objectDto, Locale locale);
...
//    ResultDto saveSvcManagement(SvcManagementDto objectDto, Locale locale) throws Exception;
     ...
     * @author HungHT
     */
    List<Select2Dto> getOZFormFileName(String currentFormFileName);
}