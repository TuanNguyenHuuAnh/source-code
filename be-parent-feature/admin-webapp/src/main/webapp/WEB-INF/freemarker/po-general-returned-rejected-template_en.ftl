...
<BODY>
    Dear <b>${maker.fullname}</b>,
    <br/>
    <br/>
    Kindly be informed that the following Purchase Order <b>${poName}</b> has been ${typeSubmit} by <b>${currentUser.fullname}</b> with comment "<i><b>${comments}</b></i>"
    <br/>
