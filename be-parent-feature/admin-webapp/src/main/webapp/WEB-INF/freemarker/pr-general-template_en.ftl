...
<p>  Dear <b>${receiverName}</b>,
    ...
    <table border="1">
	    ...
	    <#list budgetList as budget>
	        <tr>
	        	...
	        	<#if p2pGeneral.type == 3>
				<td>${budget.activityCode} - ${budget.activityName}</td>
		        <#else>
    ...
    <#if p2pGeneral.woc == 1>
    <p style="margin: 3px;"><b>WOC</b>
    <br/>
    <p style="margin: 3px;"><b>Vendor:</b> ${p2pGeneral.supplier}
    <br/>
    <p style="margin: 3px;"><b>Reason:</b> ${p2pGeneral.reason}
    </#if>
