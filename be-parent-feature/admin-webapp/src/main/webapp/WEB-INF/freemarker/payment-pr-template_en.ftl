	...
	<BODY>
		...
		<br/>
			...
			<#if param.nextStepNo == 1 >
				Kindly be informed that a new Payment Requisition PR <b>${param.paymentNo}</b> has been created by <b>${param.userRequest}</b> successfully.<br/>
				Please access to ${url} to view.
			
			<#-- 2. Khi Verifier Verify  -->
			<#elseif param.buttonId == param.paymentEnum.BTN_VERIFY_VERIFY> 
				Kindly be informed that the below Payment Requisition PR <b>${param.paymentNo}</b> has been verified by <b>${param.userRequest}</b> successfully.<br/>
				Please access to ${url} to view.
			...
			<#elseif param.buttonId == param.paymentEnum.BTN_HOD_APPROVE 
				...
				Kindly be informed that the following Payment Requisition PR <b>${param.paymentNo}</b> has been approved by <b>${param.userRequest}</b> successfully.<br/>
				Please access to ${url} to view.
			...
			<#elseif param.buttonId == param.paymentEnum.BTN_CFO_APPROVE 
				...
				Kindly be informed that Payment Requisition PR <b>${param.paymentNo}</b> has been approved by <b>${param.userRequest}</b> successfully.<br/>
				Please access to ${url} to view.
			...
			<#elseif param.nextStepNo == 98>
				Kindly be informed that the following Payment Requisition PR <b>${param.paymentNo}</b> has been rejected by <b>${param.userRequest}</b> with comment "<i><b>${param.comment}</b></i>"<br/>
			...
			<#elseif param.nextStepNo == 92 
				...
				|| param.nextStepNo == 92 
				|| param.nextStepNo == 90 >
				Kindly be informed that the following Payment Requisition PR <b>${param.paymentNo}</b> has been returned by <b>${param.userRequest}</b> with comment "<i><b>${param.comment}</b></i>"<br/>
			...
			<#else>
				Kindly be informed that Payment Requisition PR <b>${param.paymentNo}</b> has been updated by <b>${param.userRequest}</b> successfully.<br/>
				Please access to ${url} to view.
		...
		<#if param.actionLower??>
		   Note: You can also ${param.actionLower} this Payment Requisition PR directly by replying this email with <b>"${param.actionUpper}"</b>.
		   <br/><br/>
		</#if>
