...
public class DocumentMainFileRest extends AbstractRest {
    ...
    public DtsApiResponse uploadMainFile(
        ...
        try {
            ...
            // 2. Save document
            EfoOzDocMainFileDto resDoto = documentMainFileService.uploadMainFile(documentSaveReq);

            return this.successHandler.handlerSuccess(resDoto, start);
        } catch (Exception ex) {
