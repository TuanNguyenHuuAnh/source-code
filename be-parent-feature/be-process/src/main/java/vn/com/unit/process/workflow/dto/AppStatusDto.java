...
public class AppStatusDto{
    ...
    private List<JpmStatusLangDto> listJpmStatusLang;
    ...
    public List<JpmStatusLangDto> getListJpmStatusLang() {
        return listJpmStatusLang;
    }

    public void setListJpmStatusLang(List<JpmStatusLangDto> listJpmStatusLang) {
