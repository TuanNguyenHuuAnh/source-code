...
$(function(){
	...
	$("#tableList").datatables({
		url : BASE_URL + 'p2psupplier/ajaxList',
		type : 'POST',
	...
	$('#btnExport').click(function() {
		var linkExport = "p2psupplier/export-excel";
...
function onClickSearch(element, event) {
	setDataSearchHidden();
	ajaxSearch("p2psupplier/ajaxList", setConditionSearch(), "tableList", element, event);
}
...
function editItem(element, event) {
	...
	var id = row.data("id");
	var url = BASE_URL + "p2psupplier/edit?id=" + id;
...
function detailItem(element, event) {
	...
	var row = $(element).parents("tr");
	var id = row.data("id");
	var url = BASE_URL + "p2psupplier/detail?id=" + id;
