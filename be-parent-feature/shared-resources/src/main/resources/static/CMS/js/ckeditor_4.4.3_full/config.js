...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar = [
		...
		{ name: 'insert', items: [ 'Image', 'Flash', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'Iframe' ,'EmojiPanel'] },
		{ name: 'colors', items: [ 'TextColor', 'BGColor' ] },
		//{ name: 'document', groups: [ 'mode', 'document', 'doctools' ], items: [ 'Source', '-', 'null', 'null', 'null', 'null', '-', 'null' ] },
		'/',
		{ name: 'basicstyles', groups: [ 'basicstyles', 'cleanup' ,'emoji'], items: [ 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', '-', 'RemoveFormat' ] },
