		...
		if ($(".j-form-validate").valid()) {
			...
			if (insert == false) {
				...
				for(var i=0; i<SETTINGDTO.listSettingLanguageChat.length; i++){
					...
					SETTINGDTO.listSettingLanguageChat[i].listControls[j]["fieldCode"] = "OCLTMP" + j;
					...
					var html =
						 '<tr data-row-id="OCLTMP' + j + '" name="listSettingLanguageChat[' + i + '].listControls[' + j + '].fieldCode">'
