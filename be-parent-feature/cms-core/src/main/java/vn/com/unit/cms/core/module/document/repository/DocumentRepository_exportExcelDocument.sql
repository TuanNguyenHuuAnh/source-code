...
SELECT
		ROW_NUMBER() OVER (ORDER BY m_category_language.TITLE ASC, m_document.sort_order ASC, m_document.create_date DESC)   as stt
	   , m_document.code 						as code
	   ...
	   , m_document.create_date   				as create_date
