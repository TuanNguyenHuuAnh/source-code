SELECT
	...
	const. CODE 			AS type_name
FROM
	m_popup pop
LEFT JOIN jca_constant_display const ON pop.type = const.cat AND const.type = 'POPUP'
...
WHERE
	...
	/*END*/
	/*IF popupDto.type != null && popupDto.type != ''*/
	AND pop.type = /*popupDto.type*/
	/*END*/	
