 ...
 * @author hand
 */
public interface ContactEmailUpdateItemRepository extends DbRepository<ContactEmailUpdateItem, Integer> {

	List<ContactEmailUpdateItemDto> findByEmailId(@Param("emailId")Long  bookingId);
