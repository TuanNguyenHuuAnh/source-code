SELECT
	...
	city.m_country_id AS country_id,
	col.country_name ,
	city.m_region_id AS region_id,
...
FROM
	...
	LEFT JOIN jca_m_region_language AS rl ON city.m_region_id = rl.m_region_id AND cl.m_language_code = rl.m_language_code
WHERE 
