...
FROM
	...
	LEFT JOIN jca_m_language lang ON UPPER(lang.code) = UPPER(/*languageCode*/'')
	...
	LEFT JOIN jca_m_country_language AS coul ON district.m_country_id = coul.m_country_id AND lang.code = coul.m_language_code
	LEFT JOIN jca_m_region_language AS rl ON district.m_region_id = rl.m_region_id AND lang.code = rl.m_language_code
WHERE 
	...
	/*END*/
	ORDER BY district.create_date DESC