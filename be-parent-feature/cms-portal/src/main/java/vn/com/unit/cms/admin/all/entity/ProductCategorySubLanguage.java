/*******************************************************************************
 * Class        ：ProductCategorySubLanguage
 ...
 * @author hand
 */
@Table(name = "m_product_category_sub_language")
public class ProductCategorySubLanguage extends AbstractTracking {

    @Id
    @Column(name = "id")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = "SEQ_M_PRODUCT_CATEGORY_SUB_LANGUAGE")
    private Long id;
    ...
    /**
     * Get productCategorySubId
     * @return Long
     * @author hand
     */
    public Long getProductCategorySubId() {
        return productCategorySubId;
    }

    /**
     * Set productCategorySubId
     * @param   productCategorySubId
     *          type Long
     * @return
     * @author  hand
     */
    public void setProductCategorySubId(Long productCategorySubId) {
