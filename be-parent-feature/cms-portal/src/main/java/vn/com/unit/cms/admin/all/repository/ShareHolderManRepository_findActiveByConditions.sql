SELECT
	...
	AND
		(
			...
			/*END*/
			/*IF condition.ownedSharesAmount != null*/
			OR
			owned_shares_amount = /*condition.ownedSharesAmount*/
			/*END*/
			/*IF condition.dividendAmount != null*/
			OR
			dividend_amount = /*condition.dividendAmount*/
			/*END*/
