 ...
 * @author TranLTH
 */
@Table(name = "JCA_M_DISTRICT_LANGUAGE") // DatabaseConstant.TABLE_DISTRICT_LANGUAGE
public class DistrictLanguage extends AbstractTracking {

	@Id
	@Column(name = "id")
	@PrimaryKey(generationType = GenerationType.SEQUENCE, generator = "SEQ_JCA_DISTRICT_LANGUAGE")
	public Long id;

	/** Column: m_district_id type BIGINT(11) */
