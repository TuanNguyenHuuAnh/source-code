...
WHERE
	...
	AND product.M_PRODUCT_CATEGORY_ID in /*categoryListId*/()
	/*END*/
	/*IF categoryListId == null*/
	AND product.M_PRODUCT_CATEGORY_ID in ('')
	/*END*/
	/*IF categorySubListId != null*/
	AND product.m_product_category_sub_id in /*categorySubListId*/()
	/*END*/
	/*IF categorySubListId == null*/
	AND product.m_product_category_sub_id is NULL
	/*END*/
	/*IF status != null*/
        AND product.status = /*status*/
    /*END*/
ORDER BY productLan.title asc