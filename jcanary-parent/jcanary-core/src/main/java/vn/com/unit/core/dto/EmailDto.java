...
import vn.com.unit.common.dto.ConstantDisplayDto;
...
public class EmailDto {
	...
	public String getExHostName() {
		return exHostName;
	}

	public void setExHostName(String exHostName) {
		this.exHostName = exHostName;
	}
	...
	public void setExDomain(String exDomain) {
	...
	public String getStatusEmail() {
		if (statusSendMail.equals(EmailStatusEnum.EMAIL_SEND_SUCCESS.toString())) {
			statusEmail = EmailStatusEnum.EMAIL_SEND_SUCCESS.name();
		} else if (statusSendMail.equals(EmailStatusEnum.EMAIL_SENDING.toString())) {
			statusEmail = EmailStatusEnum.EMAIL_SENDING.name();
		} else if (statusSendMail.equals(EmailStatusEnum.EMAIL_SAVED.toString())) {
			statusEmail = EmailStatusEnum.EMAIL_SAVED.name();
		} else if (statusSendMail.equals(EmailStatusEnum.EMAIL_SEND_FAIL.toString())) {
			statusEmail = EmailStatusEnum.EMAIL_SEND_FAIL.name();
		} else if (statusSendMail.equals(EmailStatusEnum.UNKNOWN.toString())) {
			statusEmail = EmailStatusEnum.UNKNOWN.name();
		} else {
