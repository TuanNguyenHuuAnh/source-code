...
@Getter
@Setter
@Table(name = WorkflowConstant.TABLE_JPM_PROCESS)
public class JpmProcess extends AbstractTracking {

    /** Column: ID type NUMBER (20,0) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = WorkflowConstant.SEQ + WorkflowConstant.TABLE_JPM_PROCESS)
    private Long id;
