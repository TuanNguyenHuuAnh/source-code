...
@Getter
@Setter
@Table(name = WorkflowConstant.TABLE_JPM_STEP_LANG_DEPLOY)
public class JpmStepLangDeploy extends AbstractCreatedTracking {
    ...
    /** Column: LANG_CODE type VARCHAR2(10) NOT NULL */
