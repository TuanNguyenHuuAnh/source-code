/*******************************************************************************
 * Class        ：JpmTaskEmailAlertRepository
 ...
 * @since 01-00
 */
public interface JpmTaskEmailAlertRepository extends DbRepository<JpmTaskEmailAlert, Long>{
     ...
     */
    public List<JpmTaskEmailAlert> getJpmTaskEmailAlertListByJpmTaskId(@Param("jpmTaskId") Long jpmTaskId);
}
