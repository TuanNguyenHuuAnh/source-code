...
@Getter
@Setter
@Table(name = WorkflowConstant.TABLE_JPM_PROCESS_DEPLOY)
public class JpmProcessDeploy extends AbstractTracking {

    /** Column: ID type NUMBER (20,0) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = WorkflowConstant.SEQ + WorkflowConstant.TABLE_JPM_PROCESS_DEPLOY)
    private Long id;
    ...
    /** Column: MAJOR_VERSION type NUMBER(10,0) NOT NULL */
    @Column(name = "MAJOR_VERSION")
    private Long majorVersion;

    /** Column: MINOR_VERSION type NUMBER(10,0) NOT NULL */
    @Column(name = "MINOR_VERSION")
    private Long minorVersion;

    /** Column: EFFECTIVE_DATE type DATE NOT NULL */
    @Column(name = "EFFECTIVE_DATE")
    private Date effectiveDate;

    /** Column: BPMN_REPO_ID type NUMBER(20,0) NOT NULL */
    ...
    /** Column: BPMN_FILE_NAME type VARCHAR2(255.0) NOT NULL */
    ...
    /** Column: PROCESS_ID type NUMBER(20,0) NULL */
