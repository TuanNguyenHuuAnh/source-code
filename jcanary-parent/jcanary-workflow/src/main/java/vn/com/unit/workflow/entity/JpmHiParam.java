...
@Getter
@Setter
@Table(name = WorkflowConstant.TABLE_JPM_HI_PARAM)
public class JpmHiParam extends AbstractCreatedTracking {

    /** Column: ID type NUMBER (20,0) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = WorkflowConstant.SEQ + WorkflowConstant.TABLE_JPM_HI_PARAM)
    private Long id;
