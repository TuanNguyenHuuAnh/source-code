...
@Getter
@Setter
@Table(name = WorkflowConstant.TABLE_JPM_HI_BUSINESS)
public class JpmHiBusiness extends AbstractCreatedTracking {

    /** Column: ID type NUMBER (20,0) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = WorkflowConstant.SEQ + WorkflowConstant.TABLE_JPM_HI_BUSINESS)
    private Long id;
