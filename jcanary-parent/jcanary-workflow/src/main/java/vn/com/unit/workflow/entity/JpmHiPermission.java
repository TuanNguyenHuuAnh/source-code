...
@Getter
@Setter
@Table(name = WorkflowConstant.TABLE_JPM_HI_PERMISSION)
public class JpmHiPermission extends AbstractCreatedTracking {

    /** Column: ID type NUMBER (20,0) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = WorkflowConstant.SEQ + WorkflowConstant.TABLE_JPM_HI_PERMISSION)
    private Long id;
    ...
    /** Column: PERMISSION_ID type NUMBER(20,0) NOT NULL */
