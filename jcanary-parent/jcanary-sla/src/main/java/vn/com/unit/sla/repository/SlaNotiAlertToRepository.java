 ...
 * @author NganNH
 */
public interface SlaNotiAlertToRepository extends DbRepository<SlaNotiAlertTo, Long> {
     ...
     * @author TrieuVD
     */
    public List<SlaReceiverDto> getSlaAccountDtoListByAlertId(@Param("alertId") Long alertId, @Param("userType") String userType);
