...
@Getter
@Setter
@Table(name = SlaConstant.TABLE_SLA_NOTI_ALERT_HISTORY)
public class SlaNotiAlertHistory extends AbstractAuditTracking {

    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = SlaConstant.SEQ + SlaConstant.TABLE_SLA_NOTI_ALERT_HISTORY)
    private long id;
