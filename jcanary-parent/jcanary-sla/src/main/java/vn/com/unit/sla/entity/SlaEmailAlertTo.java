...
@Getter
@Setter
@Table(name = SlaConstant.TABLE_SLA_EMAIL_ALERT_TO)
public class SlaEmailAlertTo extends AbstractAuditTracking {

    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = SlaConstant.SEQ + SlaConstant.TABLE_SLA_EMAIL_ALERT_TO)
    private Long id;
