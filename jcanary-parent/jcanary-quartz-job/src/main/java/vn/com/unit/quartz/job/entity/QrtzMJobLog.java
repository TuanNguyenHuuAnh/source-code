...
@Getter
@Setter
@Table(name = "QRTZ_M_JOB_LOG")
public class QrtzMJobLog extends AbstractTracking{

    /** Column: ID type NUMBER(22,0) NOT NULL */
    @Id
    @Column(name = "ID")
    @PrimaryKey(generationType = GenerationType.SEQUENCE, generator = "SEQ_QRTZ_M_JOB_LOG")
    private Long id;

    /** Column: JOB_ID type NUMBER(20,0) NOT NULL */
    @Column(name = "JOB_ID")
    private Long jobId;
